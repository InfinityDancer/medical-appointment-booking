...
from src.routes import doctor_routes
...
app.include_router(doctor_routes.router, prefix="/v1/doctor")
...
def debug_versions():
    try:
        import supabase
        sv = supabase.__version__
    except Exception as e:
        sv = str(e)

    try:
        import postgrest
        pv = postgrest.__version__
    except Exception as e:
        pv = str(e)
    ...
    return {"supabase": sv, "postgrest": pv, "httpx": hv}
