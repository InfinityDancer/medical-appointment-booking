...
def check_doctor_availability(doctor_id:str,start_date:str,start_time:str,end_time:str,end_date:str,location:str,organisation_id:str):
    ...
    print(f"🔍 check_doctor_availability called with:")
    print(f"   doctor_id={doctor_id!r} (type={type(doctor_id).__name__})")
    print(f"   start_date={start_date!r}, start_time={start_time!r}")
    print(f"   end_date={end_date!r}, end_time={end_time!r}")
    print(f"   location={location!r}, organisation_id={organisation_id!r}")
    try:
